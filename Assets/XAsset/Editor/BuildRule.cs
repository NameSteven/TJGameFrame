...
namespace XAsset.Editor
{
    public abstract class BuildRule
    {
        ...
        public static List<AssetBundleBuild> GetBuilds(string manifestPath)
        {
            ...
            {
                List<string> FilesList = GetFilesWithoutDirectories(item.searchPath, item.searchPattern, item.searchOption);
                CollectDependencies(FilesList);
            }
